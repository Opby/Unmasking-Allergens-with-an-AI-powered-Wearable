...
const char* ei_classifier_inferencing_categories[] = { "background", "coughing", "crying" };
...
const ei_impulse_t impulse_625257_0 = {
    .project_id = 625257,
    .project_owner = "Isaac He",
    .project_name = "audio_coughing_sneezing_MFE",
    .impulse_id = 1,
    .impulse_name = "Time series data, Audio (MFE), Neural Network (Keras) #1 (Conv1D)",
    .deploy_version = 9,
...
ei_impulse_handle_t impulse_handle_625257_0 = ei_impulse_handle_t( &impulse_625257_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_625257_0;
